...
<div style="margin-top: 70px; text-align: center;">
    ...
    <h4 style="margin-top: -20px;">Student Affairs Division</h4>
</div>
<div style="text-align: center; margin-top: -20px;">
    <img  src="uploads/logo.png" style="width: 100px; height: 100px;">
</div>

<div style="text-align: center; margin-top: -20px;">
   <p style="font-family: Bradley Hand, cursive; font: 23px; font-style: italic; ">Certificate of Return</p>
