...
<head>
    ...
    <title>BUK Votes -  @yield('PageTitle')</title>
...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="">
            ...
            <ul class="nav navbar-nav align-items-center ms-auto">
                ...
                <li class="nav-item nav-search"><a class="nav-link nav-link-search"><i class="ficon" data-feather="search"></i></a>
                    <div class="search-input">
                        ...
                        <input class="form-control input" type="text" placeholder="Search BUK e-Votes..." tabindex="-1" data-search="search">
                        ...
                        <li class="scrollable-container media-list"><a class="d-flex" href="#">
                                <div class="list-item d-flex align-items-start">
                                    ...
                                    <div class="list-item-body flex-grow-1">
                                        <p class="media-heading"><span class="fw-bolder">No New Notification</small>
                                    </div>
                                </div>
                            </a>
                ...
                <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="user-nav d-sm-flex d-none"><span class="user-name fw-bolder">{{auth()->user()->first_name}} {{auth()->user()->middle_name}} {{auth()->user()->last_name}}</span><span class="user-status">@if(auth()->user()->reg_number != null) {{strtoupper(auth()->user()->reg_number)}} @else {{auth()->user()->email}} @endif</span></div><span class="avatar"><img class="round" src="/uploads/users/{{auth()->user()->image}}" alt="avatar" height="40" width="40"></span>
                    </a>
    ...
    <footer class="footer footer-static footer-light">
        <p class="clearfix mb-0"><span class="float-md-start d-block d-md-inline-block mt-25">COPYRIGHT &copy; 2021<a class="ms-25" href="https://1.envato.market/pixinvent_portfolio" target="_blank">Bayero University Kano</a><span class="d-none d-sm-inline-block">, All rights Reserved</span></span><span class="float-md-end d-none d-md-block">Developed by <a href="https://fb.me/katibu1"> Umar Katibu</a></span></p>
    </footer>
